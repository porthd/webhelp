...
class PorthDCodeView extends HTMLElement {
  async connectedCallback() {
    ...
    const blockButtons = this.getAttribute('block-buttons') || '';
    const themeToggleLabel = this.getAttribute('theme-button-label') || 'Theme';
    ...
    shadow.innerHTML = `
            ...
            <div style="${blockButtons}">
                ...
                <button class="copy-button">${buttonLabel}</button>
            </div>
